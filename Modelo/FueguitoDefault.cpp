...
FueguitoDefault::FueguitoDefault(int posicion_x,int posicion_y):Modelo_Jugador(NULL,posicion_x,posicion_y)
{
...
void FueguitoDefault::moverIz()

{
    this->posicion_x-=1;// el 2 seria la velocidad , si queres mas velocidad, entonces aumentas
}

void FueguitoDefault::caminar()
{
